JSONP.response({
  responseText: '﻿<!-- saved from url=(0016)http://localhost -->\
<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\
<html>\
<head>\
<meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" />\
<meta http-equiv=\"X-UA-Compatible\" content=\"IE=EmulateIE8\">\
    <title>Control-M Self Service 9.0.00.200 </title>\
    <!-- STYLES --><!-- Note: the order is important -->\
	<link rel=\"shortcut icon\" href=\"http://media.cms.bmc.com/designimages/favicon.png\">\
    <link rel=\"icon\" href=\"http://media.cms.bmc.com/designimages/favicon.png\">\
    ...
    <script type=\"text/javascript\">\
		...
		<!-- Add link tag to point to the proper locale stylesheet file for UI -->\
	...
	<script src=\"dhtml_popup.js\" type=\"text/javascript\"></script>\
</head>\
<body>\
    <div id=\"header\">\
        <div class=\"header-left\">\
		 <!-- Uncomment the line below and add image source for site logo -->\
           <img src=\"images\\bmc_logo.png\" <!--alt=\"\" -->\
            \
        </div>\
        <div class=\"header-right\">\
		<span id=\"headerTitle\" style=\"margin-left: 150px; font-size: 16px;\
			\">\
                 Control-M Self Service 9.0.00.200\
            </span>\
           \
        </div>\
    </div>\
                ...
                <div id=\"start-panel\">\
                    <table align=\"center\">\
						<tr>\
							<td class=\"loading\">\
								<script type=\"text/javascript\">\
									if (!resources || !resources[\"Loading\"] || resources[\"Loading\"] == \"\")\
										document.write(\'Loading\');\
									else { document.write(resources[\"Loading\"]); }\
								</script>\
							</td>\
						</tr>\
					</table>\
...
\
        <!-- Send feedback icon -->\
        <input id=\"sendFeedbackIcon\" type=\"hidden\" value=\"false\" />\
        <input id=\"feedbackEmail\" type=\"hidden\" value=\"\" />\
\
...
\
        ...
        <input id=\"siteName\" type=\"hidden\" value=\"Control-M Workload Automation version 8.0.00\" />\
\
...
\
        ...
        <input id=\"sys_library_command_line\" type=\"hidden\" value=\" /sql&quot;V8_DB|VW-TLV-CTM-IDD0\\SQLEXPRESS&quot;\" />\
        <input id=\"bookId\" type=\"hidden\" value=\"1163\" />\
\
		<input id= \"Forward\" type= \"hidden\" value= \"true\" />\
\
...
\
		...
		<!-- History arrow-->\
        <input id=\"historyArrows\" type=\"hidden\" value=\"true\" />\
\
        <!-- Show header-->\
        <input id=\"showHeader\" type=\"hidden\" value=\"true\" />\
		<!-- Show index-->\
        <input id=\"showIndex\" type=\"hidden\" value=\"true\" />\
		<!-- Adobe icon -->\
        <input id=\"adobeIcon\" type=\"hidden\" value=\"false\" />\
        <!-- Adobe file -->\
        <input id=\"adobeFile\" type=\"hidden\" value=\"URL_TO_PDF_FILE\" />\
\
